...
public class ContinuousActionImpl extends ActionImpl implements ContinuousAction {
	...
	public boolean ContinuousActionCondType(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					GrafcetPackage.Literals.CONTINUOUS_ACTION___CONTINUOUS_ACTION_COND_TYPE__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					...
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_continuousActionType = continuousActionType == null
							? null
							: GrafcetTables.ENUMid_ContinuousActionType
									.getEnumerationLiteralId(ClassUtil.nonNullState(continuousActionType.getName()));
					...
					if (eq) {
						...
						if (oclIsTypeOf) {
							...
							final /*@Thrown*/ SetValue oclAsSet_1 = OclAnyOclAsSetOperation.INSTANCE.evaluate(executor,
									GrafcetTables.SET_CLSSid_Operator, oclAsType_0);
							...
							final LibraryIterationExtension IMPL_closure_0_0 = (LibraryIterationExtension) TYPE_closure_0_0
									.lookupImplementation(standardLibrary, OCLstdlibTables.Operations._Set__closure);
							...
							while (true) {
								 ...
								 * operator.oclIsTypeOf(terms::RisingEdge)
								 */
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_RisingEdge_0 = idResolver
										.getClass(GrafcetTables.CLSSid_RisingEdge, null);
								final /*@NonInvalid*/ boolean oclIsTypeOf_0 = OclAnyOclIsTypeOfOperation.INSTANCE
										.evaluate(executor, operator, TYP_terms_c_c_RisingEdge_0).booleanValue();
								//
								if (oclIsTypeOf_0) {
							...
							while (true) {
								 ...
								 * operator.oclIsTypeOf(terms::FallingEdge)
								 */
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_FallingEdge_0 = idResolver
										.getClass(GrafcetTables.CLSSid_FallingEdge, null);
								final /*@NonInvalid*/ boolean oclIsTypeOf_1 = OclAnyOclIsTypeOfOperation.INSTANCE
										.evaluate(executor, operator_0, TYP_terms_c_c_FallingEdge_0).booleanValue();
								//
								if (oclIsTypeOf_1) {
	...
	public boolean ContinuousActionVarType(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IdResolver idResolver = executor.getIdResolver();
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					GrafcetPackage.Literals.CONTINUOUS_ACTION___CONTINUOUS_ACTION_VAR_TYPE__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE
					.evaluate(executor, severity_0, GrafcetTables.INT_0).booleanValue();
								...
								final AbstractBinaryOperation BODY_closure_0 = new AbstractBinaryOperation() {
									...
									public /*@Nullable*/ Object evaluate(final Executor executor, final TypeId typeId,
										...
										final /*@Thrown*/ SetValue oclAsSet_0 = OclAnyOclAsSetOperation.INSTANCE
												.evaluate(executor, GrafcetTables.SET_CLSSid_Term, local_0);
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Condition.class) {
			...
			case GrafcetPackage.CONDITION___CONDITION_TERM_TYPE__DIAGNOSTICCHAIN_MAP:
				return GrafcetPackage.CONTINUOUS_ACTION___CONDITION_TERM_TYPE__DIAGNOSTICCHAIN_MAP;
			case GrafcetPackage.CONDITION___CONDITION_VARIABLE_TYPE__DIAGNOSTICCHAIN_MAP:
				return GrafcetPackage.CONTINUOUS_ACTION___CONDITION_VARIABLE_TYPE__DIAGNOSTICCHAIN_MAP;
			default:
				return -1;
			}
		}
