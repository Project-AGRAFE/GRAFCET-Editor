...
public class IntegerConstantImpl extends ConstantImpl implements IntegerConstant {
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermsPackage.INTEGER_CONSTANT__VALUE, oldValue,
					value));
	}
	...
	public boolean InputSizeOutputTypesIntConts(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor,
					TermsPackage.Literals.INTEGER_CONSTANT___INPUT_SIZE_OUTPUT_TYPES_INT_CONTS__DIAGNOSTICCHAIN_MAP);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case TermsPackage.INTEGER_CONSTANT___INPUT_SIZE_OUTPUT_TYPES_INT_CONTS__DIAGNOSTICCHAIN_MAP:
			return InputSizeOutputTypesIntConts((DiagnosticChain) arguments.get(0),
