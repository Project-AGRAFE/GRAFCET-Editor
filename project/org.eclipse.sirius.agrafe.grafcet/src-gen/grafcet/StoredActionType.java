 ...
 * <!-- end-user-doc -->
 * @see grafcet.GrafcetPackage#getStoredActionType()
 * @model
 * @generated
 */
public enum StoredActionType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final StoredActionType[] VALUES_ARRAY =
		new StoredActionType[] {
			ACTIVATION,
			DEACTIVATION,
			EVENT,
		};
	...
	public static StoredActionType get(int value) {
		switch (value) {
			...
			case DEACTIVATION_VALUE: return DEACTIVATION;
