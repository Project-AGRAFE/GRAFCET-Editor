 ...
 * <!-- end-user-doc -->
 * @see grafcet.GrafcetPackage#getContinuousActionType()
 * @model
 * @generated
 */
public enum ContinuousActionType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ContinuousActionType[] VALUES_ARRAY =
		new ContinuousActionType[] {
			CONTINUOUS_ACTION,
	...
	public static ContinuousActionType get(int value) {
		switch (value) {
			case CONTINUOUS_ACTION_VALUE: return CONTINUOUS_ACTION;
			case ASSIGNATION_CONDITION_VALUE: return ASSIGNATION_CONDITION;
		}
		return null;
	}
