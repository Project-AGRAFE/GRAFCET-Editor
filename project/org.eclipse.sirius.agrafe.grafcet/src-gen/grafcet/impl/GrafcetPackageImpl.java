...
import grafcet.Action;
import grafcet.ActionLink;
import grafcet.ActionType;
import grafcet.Arc;
import grafcet.Condition;
import grafcet.ContinuousAction;
import grafcet.ContinuousActionType;
import grafcet.EnclosingStep;
import grafcet.EntryStep;
import grafcet.ExitStep;
import grafcet.ForcingOrder;
import grafcet.ForcingOrderType;
import grafcet.Grafcet;
import grafcet.GrafcetFactory;
import grafcet.GrafcetPackage;
import grafcet.InitializableType;
import grafcet.Macrostep;
import grafcet.MacrostepExpansion;
import grafcet.Node;
import grafcet.PartialGrafcet;
import grafcet.Step;
import grafcet.StoredAction;
import grafcet.StoredActionType;
import grafcet.Synchronization;
import grafcet.TimeCondition;
import grafcet.TimeConditionType;
import grafcet.TimeUnit;
import grafcet.Transition;
import grafcet.VariableDeclarationContainer;

import grafcet.util.GrafcetValidator;
...
public class GrafcetPackageImpl extends EPackageImpl implements GrafcetPackage {
	 ...
	 * @see grafcet.GrafcetPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGrafcet_Name(), ecorePackage.getEString(), "name", "GRAFCETChart", 1, 1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_VariableDeclarationContainer(), this.getVariableDeclarationContainer(), null, "variableDeclarationContainer", null, 0, 1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_PartialGrafcets(), this.getGrafcet(), null, "partialGrafcets", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_Steps(), this.getInitializableType(), null, "steps", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_Transitions(), this.getTransition(), null, "transitions", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_Synchronizations(), this.getSynchronization(), null, "synchronizations", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_Macrosteps(), this.getMacrostep(), null, "macrosteps", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_Arcs(), this.getArc(), null, "arcs", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_ActionTypes(), this.getActionType(), null, "actionTypes", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGrafcet_ActionLinks(), this.getActionLink(), null, "actionLinks", null, 0, -1, Grafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getVariableDeclarationContainer_VariableDeclarations(), theTermsPackage.getVariableDeclaration(), null, "variableDeclarations", null, 0, -1, VariableDeclarationContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(partialGrafcetEClass, PartialGrafcet.class, "PartialGrafcet", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPartialGrafcet_EnclosingStep(), this.getEnclosingStep(), null, "enclosingStep", null, 0, 1, PartialGrafcet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(macrostepExpansionEClass, MacrostepExpansion.class, "MacrostepExpansion", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMacrostepExpansion_EntryStep(), this.getEntryStep(), null, "entryStep", null, 1, -1, MacrostepExpansion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMacrostepExpansion_ExitStep(), this.getExitStep(), null, "exitStep", null, 1, 1, MacrostepExpansion.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(initializableTypeEClass, InitializableType.class, "InitializableType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getInitializableType_Initial(), ecorePackage.getEBoolean(), "initial", "false", 1, 1, InitializableType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getInitializableType_ActivationLink(), ecorePackage.getEBoolean(), "activationLink", "false", 1, 1, InitializableType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(enclosingStepEClass, EnclosingStep.class, "EnclosingStep", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEnclosingStep_PartialGrafcets(), this.getPartialGrafcet(), null, "partialGrafcets", null, 1, -1, EnclosingStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(macrostepEClass, Macrostep.class, "Macrostep", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMacrostep_Expansion(), this.getMacrostepExpansion(), null, "expansion", null, 1, 1, Macrostep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(entryStepEClass, EntryStep.class, "EntryStep", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getActionType_Id(), ecorePackage.getEInt(), "id", null, 1, 1, ActionType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(forcingOrderEClass, ForcingOrder.class, "ForcingOrder", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getForcingOrder_PartialGrafcet(), this.getPartialGrafcet(), null, "partialGrafcet", null, 1, 1, ForcingOrder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getForcingOrder_ForcedSteps(), this.getInitializableType(), null, "forcedSteps", null, 0, -1, ForcingOrder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getForcingOrder_ForcingOrderType(), this.getForcingOrderType(), "forcingOrderType", "currentSituation", 0, 1, ForcingOrder.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(actionEClass, Action.class, "Action", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getAction_Variable(), theTermsPackage.getVariable(), null, "variable", null, 1, 1, Action.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(getAction__ActionOutputVariableType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "ActionOutputVariableType", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(storedActionEClass, StoredAction.class, "StoredAction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStoredAction_StoredActionType(), this.getStoredActionType(), "storedActionType", "activation", 1, 1, StoredAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStoredAction_Value(), theTermsPackage.getTerm(), null, "value", null, 1, 1, StoredAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getStoredAction__StoredActionCondType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "StoredActionCondType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getStoredAction__StoredActionVarType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "StoredActionVarType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEClass(continuousActionEClass, ContinuousAction.class, "ContinuousAction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getContinuousAction_ContinuousActionType(), this.getContinuousActionType(), "continuousActionType", "continuousAction", 0, 1, ContinuousAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getContinuousAction__ContinuousActionCondType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "ContinuousActionCondType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getContinuousAction__ContinuousActionVarType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "ContinuousActionVarType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEReference(getActionLink_Step(), this.getStep(), null, "step", null, 1, 1, ActionLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getActionLink_ActionType(), this.getActionType(), null, "actionType", null, 1, 1, ActionLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(timeConditionEClass, TimeCondition.class, "TimeCondition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTimeCondition_DelayTime(), ecorePackage.getEInt(), "delayTime", "0", 1, 1, TimeCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeCondition_ResetTime(), ecorePackage.getEInt(), "resetTime", "0", 1, 1, TimeCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeCondition_Unit(), this.getTimeUnit(), "unit", null, 0, 1, TimeCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeCondition_TimeConditionType(), this.getTimeConditionType(), "timeConditionType", null, 0, 1, TimeCondition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(conditionEClass, Condition.class, "Condition", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCondition_Term(), theTermsPackage.getTerm(), null, "term", null, 0, 1, Condition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getCondition__ConditionTermType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "ConditionTermType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getCondition__ConditionVariableType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "ConditionVariableType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (actionEClass,
		   source,
		   new String[] {
			   "constraints", "ActionOutputVariableType"
		   });
		addAnnotation
		  (storedActionEClass,
		   source,
		   new String[] {
			   "constraints", "StoredActionVarType"
		   });
		addAnnotation
		  (continuousActionEClass,
		   source,
		   new String[] {
			   "constraints", "ContinuousActionVarType"
		   });
		addAnnotation
		  (conditionEClass,
		   source,
		   new String[] {
			   "constraints", "ConditionVariableType"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getStoredAction__StoredActionVarType__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.variable.variableDeclaration.sort.oclType() = self.value.sort.oclType()"
		   });
		addAnnotation
