...
public class GrafcetFactoryImpl extends EFactoryImpl implements GrafcetFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case GrafcetPackage.VARIABLE_DECLARATION_CONTAINER: return createVariableDeclarationContainer();
			case GrafcetPackage.PARTIAL_GRAFCET: return createPartialGrafcet();
			case GrafcetPackage.MACROSTEP_EXPANSION: return createMacrostepExpansion();
			case GrafcetPackage.NODE: return createNode();
			case GrafcetPackage.INITIALIZABLE_TYPE: return createInitializableType();
			case GrafcetPackage.ENCLOSING_STEP: return createEnclosingStep();
			case GrafcetPackage.STEP: return createStep();
			case GrafcetPackage.TRANSITION: return createTransition();
			case GrafcetPackage.SYNCHRONIZATION: return createSynchronization();
			case GrafcetPackage.MACROSTEP: return createMacrostep();
			case GrafcetPackage.ENTRY_STEP: return createEntryStep();
			case GrafcetPackage.EXIT_STEP: return createExitStep();
			case GrafcetPackage.ARC: return createArc();
			case GrafcetPackage.ACTION_TYPE: return createActionType();
			case GrafcetPackage.FORCING_ORDER: return createForcingOrder();
			case GrafcetPackage.ACTION: return createAction();
			case GrafcetPackage.STORED_ACTION: return createStoredAction();
			case GrafcetPackage.CONTINUOUS_ACTION: return createContinuousAction();
			case GrafcetPackage.ACTION_LINK: return createActionLink();
			case GrafcetPackage.TIME_CONDITION: return createTimeCondition();
			case GrafcetPackage.CONDITION: return createCondition();
			default:
