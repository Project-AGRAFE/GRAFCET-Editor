 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.MacrostepExpansionImpl#getEntryStep <em>Entry Step</em>}</li>
 *   <li>{@link grafcet.impl.MacrostepExpansionImpl#getExitStep <em>Exit Step</em>}</li>
 * </ul>
 *
 * @NOT generated
 */
public class MacrostepExpansionImpl extends GrafcetImpl implements MacrostepExpansion, Serializable{
	/**
	...
	public EList<EntryStep> getEntryStep() {
		if (entryStep == null) {
			entryStep = new EObjectContainmentEList<EntryStep>(EntryStep.class, this, GrafcetPackage.MACROSTEP_EXPANSION__ENTRY_STEP);
		}
		return entryStep;
	}
	...
	public NotificationChain basicSetExitStep(ExitStep newExitStep, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrafcetPackage.MACROSTEP_EXPANSION__EXIT_STEP, oldExitStep, newExitStep);
	...
	public void setExitStep(ExitStep newExitStep) {
		if (newExitStep != exitStep) {
			...
			if (exitStep != null)
				msgs = ((InternalEObject)exitStep).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.MACROSTEP_EXPANSION__EXIT_STEP, null, msgs);
			if (newExitStep != null)
				msgs = ((InternalEObject)newExitStep).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.MACROSTEP_EXPANSION__EXIT_STEP, null, msgs);
			msgs = basicSetExitStep(newExitStep, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.MACROSTEP_EXPANSION__EXIT_STEP, newExitStep, newExitStep));
	}
