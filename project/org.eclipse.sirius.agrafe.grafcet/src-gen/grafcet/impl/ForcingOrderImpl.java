 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.ForcingOrderImpl#getPartialGrafcet <em>Partial Grafcet</em>}</li>
 *   <li>{@link grafcet.impl.ForcingOrderImpl#getForcedSteps <em>Forced Steps</em>}</li>
 *   <li>{@link grafcet.impl.ForcingOrderImpl#getForcingOrderType <em>Forcing Order Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ForcingOrderImpl extends ActionTypeImpl implements ForcingOrder {
		...
		if (partialGrafcet != null && partialGrafcet.eIsProxy()) {
			...
			if (partialGrafcet != oldPartialGrafcet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GrafcetPackage.FORCING_ORDER__PARTIAL_GRAFCET, oldPartialGrafcet, partialGrafcet));
			}
		}
	...
	public void setPartialGrafcet(PartialGrafcet newPartialGrafcet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.FORCING_ORDER__PARTIAL_GRAFCET, oldPartialGrafcet, partialGrafcet));
	}
	...
	public EList<InitializableType> getForcedSteps() {
		if (forcedSteps == null) {
			forcedSteps = new EObjectResolvingEList<InitializableType>(InitializableType.class, this, GrafcetPackage.FORCING_ORDER__FORCED_STEPS);
		}
		return forcedSteps;
	}
	...
	public void setForcingOrderType(ForcingOrderType newForcingOrderType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.FORCING_ORDER__FORCING_ORDER_TYPE, oldForcingOrderType, forcingOrderType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GrafcetPackage.FORCING_ORDER__PARTIAL_GRAFCET:
				if (resolve) return getPartialGrafcet();
