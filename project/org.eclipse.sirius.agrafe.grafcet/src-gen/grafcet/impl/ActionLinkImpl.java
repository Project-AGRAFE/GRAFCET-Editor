 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.ActionLinkImpl#getStep <em>Step</em>}</li>
 *   <li>{@link grafcet.impl.ActionLinkImpl#getActionType <em>Action Type</em>}</li>
 * </ul>
 *
 * @NOT generated
 */
public class ActionLinkImpl extends MinimalEObjectImpl.Container implements ActionLink, Serializable {
	/**
		...
		if (step != null && step.eIsProxy()) {
			...
			if (step != oldStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GrafcetPackage.ACTION_LINK__STEP, oldStep, step));
			}
		}
		return step;
	}
	...
	public ActionType getActionType() {
		if (actionType != null && actionType.eIsProxy()) {
			...
			if (actionType != oldActionType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GrafcetPackage.ACTION_LINK__ACTION_TYPE, oldActionType, actionType));
			}
		}
		return actionType;
	}
	...
	public void setActionType(ActionType newActionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.ACTION_LINK__ACTION_TYPE, oldActionType, actionType));
	}
