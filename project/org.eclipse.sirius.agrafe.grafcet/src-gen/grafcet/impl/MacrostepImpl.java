 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.MacrostepImpl#getExpansion <em>Expansion</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MacrostepImpl extends NodeImpl implements Macrostep {
		...
		if (expansion != null && expansion.eIsProxy()) {
			...
			if (expansion != oldExpansion) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GrafcetPackage.MACROSTEP__EXPANSION, oldExpansion, expansion));
			}
		}
		return expansion;
	}
	...
	public void setExpansion(MacrostepExpansion newExpansion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.MACROSTEP__EXPANSION, oldExpansion, expansion));
	}
