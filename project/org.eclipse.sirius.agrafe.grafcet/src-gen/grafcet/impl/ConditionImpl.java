 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.ConditionImpl#getTerm <em>Term</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionImpl extends MinimalEObjectImpl.Container implements Condition {
	...
	public NotificationChain basicSetTerm(Term newTerm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrafcetPackage.CONDITION__TERM, oldTerm, newTerm);
	...
	public void setTerm(Term newTerm) {
		if (newTerm != term) {
			...
			if (term != null)
				msgs = ((InternalEObject)term).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.CONDITION__TERM, null, msgs);
			if (newTerm != null)
				msgs = ((InternalEObject)newTerm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.CONDITION__TERM, null, msgs);
