 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.GrafcetImpl#getName <em>Name</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getVariableDeclarationContainer <em>Variable Declaration Container</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getPartialGrafcets <em>Partial Grafcets</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getSteps <em>Steps</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getTransitions <em>Transitions</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getSynchronizations <em>Synchronizations</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getMacrosteps <em>Macrosteps</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getArcs <em>Arcs</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getActionTypes <em>Action Types</em>}</li>
 *   <li>{@link grafcet.impl.GrafcetImpl#getActionLinks <em>Action Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GrafcetImpl extends MinimalEObjectImpl.Container implements Grafcet {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVariableDeclarationContainer(VariableDeclarationContainer newVariableDeclarationContainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrafcetPackage.GRAFCET__VARIABLE_DECLARATION_CONTAINER, oldVariableDeclarationContainer, newVariableDeclarationContainer);
	...
	public void setVariableDeclarationContainer(VariableDeclarationContainer newVariableDeclarationContainer) {
		if (newVariableDeclarationContainer != variableDeclarationContainer) {
			...
			if (variableDeclarationContainer != null)
				msgs = ((InternalEObject)variableDeclarationContainer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.GRAFCET__VARIABLE_DECLARATION_CONTAINER, null, msgs);
			if (newVariableDeclarationContainer != null)
				msgs = ((InternalEObject)newVariableDeclarationContainer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.GRAFCET__VARIABLE_DECLARATION_CONTAINER, null, msgs);
			msgs = basicSetVariableDeclarationContainer(newVariableDeclarationContainer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.GRAFCET__VARIABLE_DECLARATION_CONTAINER, newVariableDeclarationContainer, newVariableDeclarationContainer));
	}
	...
	public EList<Grafcet> getPartialGrafcets() {
		if (partialGrafcets == null) {
			partialGrafcets = new EObjectContainmentEList<Grafcet>(Grafcet.class, this, GrafcetPackage.GRAFCET__PARTIAL_GRAFCETS);
		}
	...
	public EList<InitializableType> getSteps() {
		if (steps == null) {
			steps = new EObjectContainmentEList<InitializableType>(InitializableType.class, this, GrafcetPackage.GRAFCET__STEPS);
		}
		return steps;
	}
	...
	public EList<Transition> getTransitions() {
		if (transitions == null) {
			transitions = new EObjectContainmentEList<Transition>(Transition.class, this, GrafcetPackage.GRAFCET__TRANSITIONS);
		}
		return transitions;
	}
	...
	public EList<Synchronization> getSynchronizations() {
		if (synchronizations == null) {
			synchronizations = new EObjectContainmentEList<Synchronization>(Synchronization.class, this, GrafcetPackage.GRAFCET__SYNCHRONIZATIONS);
		}
	...
	public EList<Macrostep> getMacrosteps() {
		if (macrosteps == null) {
			macrosteps = new EObjectContainmentEList<Macrostep>(Macrostep.class, this, GrafcetPackage.GRAFCET__MACROSTEPS);
		}
		return macrosteps;
	}
	...
	public EList<ActionType> getActionTypes() {
		if (actionTypes == null) {
			actionTypes = new EObjectContainmentEList<ActionType>(ActionType.class, this, GrafcetPackage.GRAFCET__ACTION_TYPES);
		}
		return actionTypes;
	}
	...
	public EList<ActionLink> getActionLinks() {
		if (actionLinks == null) {
			actionLinks = new EObjectContainmentEList<ActionLink>(ActionLink.class, this, GrafcetPackage.GRAFCET__ACTION_LINKS);
		}
		return actionLinks;
	}
