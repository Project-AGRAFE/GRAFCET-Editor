 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.StoredActionImpl#getTerm <em>Term</em>}</li>
 *   <li>{@link grafcet.impl.StoredActionImpl#getStoredActionType <em>Stored Action Type</em>}</li>
 *   <li>{@link grafcet.impl.StoredActionImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StoredActionImpl extends ActionImpl implements StoredAction {
	...
	public NotificationChain basicSetTerm(Term newTerm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrafcetPackage.STORED_ACTION__TERM, oldTerm, newTerm);
	...
	public void setTerm(Term newTerm) {
		if (newTerm != term) {
			...
			if (term != null)
				msgs = ((InternalEObject)term).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.STORED_ACTION__TERM, null, msgs);
			if (newTerm != null)
				msgs = ((InternalEObject)newTerm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.STORED_ACTION__TERM, null, msgs);
			msgs = basicSetTerm(newTerm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.STORED_ACTION__TERM, newTerm, newTerm));
	}
	...
	public void setStoredActionType(StoredActionType newStoredActionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.STORED_ACTION__STORED_ACTION_TYPE, oldStoredActionType, storedActionType));
	}
	...
	public NotificationChain basicSetValue(Term newValue, NotificationChain msgs) {
		...
		value = newValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrafcetPackage.STORED_ACTION__VALUE, oldValue, newValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setValue(Term newValue) {
		if (newValue != value) {
			NotificationChain msgs = null;
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.STORED_ACTION__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.STORED_ACTION__VALUE, null, msgs);
			msgs = basicSetValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.STORED_ACTION__VALUE, newValue, newValue));
	}
	...
	public boolean StoredActionCondType(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, GrafcetPackage.Literals.STORED_ACTION___STORED_ACTION_COND_TYPE__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					...
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_storedActionType = GrafcetTables.ENUMid_StoredActionType.getEnumerationLiteralId(ClassUtil.nonNullState(storedActionType.getName()));
					...
					if (!eq) {
						...
						try {
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_Variable = idResolver.getClass(GrafcetTables.CLSSid_Variable, null);
							final /*@NonInvalid*/ Term term = this.getTerm();
							final /*@Thrown*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, term, TYP_terms_c_c_Variable).booleanValue();
							/*@Thrown*/ boolean local_2;
							if (oclIsTypeOf) {
								local_2 = false;
							}
							else {
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_Operator_0 = idResolver.getClass(GrafcetTables.CLSSid_Operator, null);
								final /*@Thrown*/ Operator oclAsType_0 = (Operator)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, term, TYP_terms_c_c_Operator_0);
								...
								final AbstractBinaryOperation BODY_closure_0_0 = new AbstractBinaryOperation() {
									...
									public /*@Nullable*/ Object evaluate(final Executor executor, final TypeId typeId, final /*@Nullable*/ Object oclAsSet_1, final /*@NonInvalid*/ Object term_3) {
										...
										final /*@Thrown*/ SetValue selectByKind_0 = (SetValue)CollectionSelectByKindOperation.INSTANCE.evaluate(executor, oclAsSet_2, TYP_terms_c_c_Operator_0);
								...
								while (true) {
									 ...
									 * operator.oclIsTypeOf(terms::RisingEdge)
									 */
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_RisingEdge = idResolver.getClass(GrafcetTables.CLSSid_RisingEdge, null);
									final /*@NonInvalid*/ boolean oclIsTypeOf_0 = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, operator, TYP_terms_c_c_RisingEdge).booleanValue();
									//
									if (oclIsTypeOf_0) {
								...
								while (true) {
									 ...
									 * operator.oclIsTypeOf(terms::FallingEdge)
									 */
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_FallingEdge = idResolver.getClass(GrafcetTables.CLSSid_FallingEdge, null);
									final /*@NonInvalid*/ boolean oclIsTypeOf_1 = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, operator_0, TYP_terms_c_c_FallingEdge).booleanValue();
									//
									if (oclIsTypeOf_1) {
								...
								final /*@Thrown*/ boolean gt = OclComparableGreaterThanOperation.INSTANCE.evaluate(executor, sum, GrafcetTables.INT_0).booleanValue();
								local_2 = gt;
							}
						...
						if (CAUGHT_local_2 == ValueUtil.TRUE_VALUE) {
							result = ValueUtil.TRUE_VALUE;
						}
						else {
							if (CAUGHT_local_2 instanceof InvalidValueException) {
								throw (InvalidValueException)CAUGHT_local_2;
							}
	...
	public boolean StoredActionVarType(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			 ...
			 */
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this, context);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, GrafcetPackage.Literals.STORED_ACTION___STORED_ACTION_VAR_TYPE__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, GrafcetTables.INT_0).booleanValue();
			...
			if (le) {
				...
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class oclType = (org.eclipse.ocl.pivot.Class)OclAnyOclTypeOperation.INSTANCE.evaluate(executor, sort);
				final /*@NonInvalid*/ Term value = this.getValue();
				final /*@NonInvalid*/ Sort sort_0 = value.getSort();
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class oclType_0 = (org.eclipse.ocl.pivot.Class)OclAnyOclTypeOperation.INSTANCE.evaluate(executor, sort_0);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Condition.class) {
			switch (derivedFeatureID) {
				case GrafcetPackage.STORED_ACTION__TERM: return GrafcetPackage.CONDITION__TERM;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Condition.class) {
			switch (baseFeatureID) {
				case GrafcetPackage.CONDITION__TERM: return GrafcetPackage.STORED_ACTION__TERM;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Condition.class) {
			switch (baseOperationID) {
				case GrafcetPackage.CONDITION___CONDITION_TERM_TYPE__DIAGNOSTICCHAIN_MAP: return GrafcetPackage.STORED_ACTION___CONDITION_TERM_TYPE__DIAGNOSTICCHAIN_MAP;
				case GrafcetPackage.CONDITION___CONDITION_VARIABLE_TYPE__DIAGNOSTICCHAIN_MAP: return GrafcetPackage.STORED_ACTION___CONDITION_VARIABLE_TYPE__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
