 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.EnclosingStepImpl#getPartialGrafcets <em>Partial Grafcets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnclosingStepImpl extends InitializableTypeImpl implements EnclosingStep {
	...
	public EList<PartialGrafcet> getPartialGrafcets() {
		if (partialGrafcets == null) {
			partialGrafcets = new EObjectResolvingEList<PartialGrafcet>(PartialGrafcet.class, this, GrafcetPackage.ENCLOSING_STEP__PARTIAL_GRAFCETS);
		}
