 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.ActionImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionImpl extends ActionTypeImpl implements Action {
	...
	public NotificationChain basicSetVariable(Variable newVariable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrafcetPackage.ACTION__VARIABLE, oldVariable, newVariable);
	...
	public void setVariable(Variable newVariable) {
		if (newVariable != variable) {
			...
			if (variable != null)
				msgs = ((InternalEObject)variable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.ACTION__VARIABLE, null, msgs);
			if (newVariable != null)
				msgs = ((InternalEObject)newVariable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.ACTION__VARIABLE, null, msgs);
			msgs = basicSetVariable(newVariable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.ACTION__VARIABLE, newVariable, newVariable));
	}
	...
	public boolean ActionOutputVariableType(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, GrafcetPackage.Literals.ACTION___ACTION_OUTPUT_VARIABLE_TYPE__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_grafcet_c_c_StoredAction = idResolver.getClass(GrafcetTables.CLSSid_StoredAction, null);
				...
				final /*@NonInvalid*/ VariableDeclarationType variableDeclarationType = variableDeclaration.getVariableDeclarationType();
				final /*@NonInvalid*/ EnumerationLiteralId BOXED_variableDeclarationType = variableDeclarationType == null ? null : GrafcetTables.ENUMid_VariableDeclarationType.getEnumerationLiteralId(ClassUtil.nonNullState(variableDeclarationType.getName()));
				...
				if (eq) {
					...
					final /*@NonInvalid*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, this, TYP_grafcet_c_c_StoredAction).booleanValue();
