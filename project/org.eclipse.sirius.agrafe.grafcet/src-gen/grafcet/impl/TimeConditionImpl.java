 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.TimeConditionImpl#getDelayTime <em>Delay Time</em>}</li>
 *   <li>{@link grafcet.impl.TimeConditionImpl#getResetTime <em>Reset Time</em>}</li>
 *   <li>{@link grafcet.impl.TimeConditionImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link grafcet.impl.TimeConditionImpl#getTimeConditionType <em>Time Condition Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeConditionImpl extends ConditionImpl implements TimeCondition {
	...
	public void setDelayTime(int newDelayTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.TIME_CONDITION__DELAY_TIME, oldDelayTime, delayTime));
	}
	...
	public void setResetTime(int newResetTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.TIME_CONDITION__RESET_TIME, oldResetTime, resetTime));
	}
	...
	public void setTimeConditionType(TimeConditionType newTimeConditionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.TIME_CONDITION__TIME_CONDITION_TYPE, oldTimeConditionType, timeConditionType));
	}
