 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.InitializableTypeImpl#isInitial <em>Initial</em>}</li>
 *   <li>{@link grafcet.impl.InitializableTypeImpl#isActivationLink <em>Activation Link</em>}</li>
 * </ul>
 *
 * @NOT generated
 */
public class InitializableTypeImpl extends NodeImpl implements InitializableType, Serializable {
	/**
	...
	public void setInitial(boolean newInitial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.INITIALIZABLE_TYPE__INITIAL, oldInitial, initial));
	}
	...
	public void setActivationLink(boolean newActivationLink) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.INITIALIZABLE_TYPE__ACTIVATION_LINK, oldActivationLink, activationLink));
	}
