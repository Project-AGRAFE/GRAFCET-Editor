 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.TransitionImpl#getTerm <em>Term</em>}</li>
 *   <li>{@link grafcet.impl.TransitionImpl#getDelayTime <em>Delay Time</em>}</li>
 *   <li>{@link grafcet.impl.TransitionImpl#getResetTime <em>Reset Time</em>}</li>
 *   <li>{@link grafcet.impl.TransitionImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link grafcet.impl.TransitionImpl#getTimeConditionType <em>Time Condition Type</em>}</li>
 * </ul>
 *
 * @NOT generated
 */
public class TransitionImpl extends NodeImpl implements Transition, Serializable {
	/**
	...
	public NotificationChain basicSetTerm(Term newTerm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrafcetPackage.TRANSITION__TERM, oldTerm, newTerm);
	...
	public void setTerm(Term newTerm) {
		if (newTerm != term) {
			...
			if (term != null)
				msgs = ((InternalEObject)term).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.TRANSITION__TERM, null, msgs);
			if (newTerm != null)
				msgs = ((InternalEObject)newTerm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GrafcetPackage.TRANSITION__TERM, null, msgs);
	...
	public void setDelayTime(int newDelayTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.TRANSITION__DELAY_TIME, oldDelayTime, delayTime));
	}
	...
	public void setResetTime(int newResetTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.TRANSITION__RESET_TIME, oldResetTime, resetTime));
	}
	...
	public void setTimeConditionType(TimeConditionType newTimeConditionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.TRANSITION__TIME_CONDITION_TYPE, oldTimeConditionType, timeConditionType));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Condition.class) {
			switch (derivedFeatureID) {
				case GrafcetPackage.TRANSITION__TERM: return GrafcetPackage.CONDITION__TERM;
				default: return -1;
			}
		}
		if (baseClass == TimeCondition.class) {
			switch (derivedFeatureID) {
				case GrafcetPackage.TRANSITION__DELAY_TIME: return GrafcetPackage.TIME_CONDITION__DELAY_TIME;
				case GrafcetPackage.TRANSITION__RESET_TIME: return GrafcetPackage.TIME_CONDITION__RESET_TIME;
				case GrafcetPackage.TRANSITION__UNIT: return GrafcetPackage.TIME_CONDITION__UNIT;
				case GrafcetPackage.TRANSITION__TIME_CONDITION_TYPE: return GrafcetPackage.TIME_CONDITION__TIME_CONDITION_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Condition.class) {
			switch (baseFeatureID) {
				case GrafcetPackage.CONDITION__TERM: return GrafcetPackage.TRANSITION__TERM;
				default: return -1;
			}
		}
		if (baseClass == TimeCondition.class) {
			switch (baseFeatureID) {
				case GrafcetPackage.TIME_CONDITION__DELAY_TIME: return GrafcetPackage.TRANSITION__DELAY_TIME;
				case GrafcetPackage.TIME_CONDITION__RESET_TIME: return GrafcetPackage.TRANSITION__RESET_TIME;
				case GrafcetPackage.TIME_CONDITION__UNIT: return GrafcetPackage.TRANSITION__UNIT;
				case GrafcetPackage.TIME_CONDITION__TIME_CONDITION_TYPE: return GrafcetPackage.TRANSITION__TIME_CONDITION_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Condition.class) {
			switch (baseOperationID) {
				case GrafcetPackage.CONDITION___CONDITION_TERM_TYPE__DIAGNOSTICCHAIN_MAP: return GrafcetPackage.TRANSITION___CONDITION_TERM_TYPE__DIAGNOSTICCHAIN_MAP;
				case GrafcetPackage.CONDITION___CONDITION_VARIABLE_TYPE__DIAGNOSTICCHAIN_MAP: return GrafcetPackage.TRANSITION___CONDITION_VARIABLE_TYPE__DIAGNOSTICCHAIN_MAP;
				default: return -1;
			}
		}
		if (baseClass == TimeCondition.class) {
