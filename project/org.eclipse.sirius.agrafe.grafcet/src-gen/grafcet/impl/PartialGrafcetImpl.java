 ...
 * </p>
 * <ul>
 *   <li>{@link grafcet.impl.PartialGrafcetImpl#getEnclosingStep <em>Enclosing Step</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PartialGrafcetImpl extends GrafcetImpl implements PartialGrafcet {
		...
		if (enclosingStep != null && enclosingStep.eIsProxy()) {
			...
			if (enclosingStep != oldEnclosingStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GrafcetPackage.PARTIAL_GRAFCET__ENCLOSING_STEP, oldEnclosingStep, enclosingStep));
			}
		}
	...
	public void setEnclosingStep(EnclosingStep newEnclosingStep) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrafcetPackage.PARTIAL_GRAFCET__ENCLOSING_STEP, oldEnclosingStep, enclosingStep));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GrafcetPackage.PARTIAL_GRAFCET__ENCLOSING_STEP:
				if (resolve) return getEnclosingStep();
