	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case GrafcetPackage.PARTIAL_GRAFCET: {
				...
				if (result == null) result = caseGrafcet(partialGrafcet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.MACROSTEP_EXPANSION: {
				...
				if (result == null) result = caseGrafcet(macrostepExpansion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case GrafcetPackage.INITIALIZABLE_TYPE: {
				...
				if (result == null) result = caseNode(initializableType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.ENCLOSING_STEP: {
				...
				if (result == null) result = caseInitializableType(enclosingStep);
				if (result == null) result = caseNode(enclosingStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.STEP: {
				...
				if (result == null) result = caseInitializableType(step);
			...
			case GrafcetPackage.TRANSITION: {
				...
				if (result == null) result = caseTimeCondition(transition);
				if (result == null) result = caseCondition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case GrafcetPackage.MACROSTEP: {
				...
				if (result == null) result = caseNode(macrostep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.ENTRY_STEP: {
				...
				if (result == null) result = caseNode(entryStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.EXIT_STEP: {
				...
				if (result == null) result = caseNode(exitStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case GrafcetPackage.FORCING_ORDER: {
				...
				if (result == null) result = caseActionType(forcingOrder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.ACTION: {
				...
				if (result == null) result = caseActionType(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.STORED_ACTION: {
				...
				if (result == null) result = caseCondition(storedAction);
				if (result == null) result = caseActionType(storedAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GrafcetPackage.CONTINUOUS_ACTION: {
				...
				if (result == null) result = caseAction(continuousAction);
				if (result == null) result = caseTimeCondition(continuousAction);
				if (result == null) result = caseActionType(continuousAction);
				if (result == null) result = caseCondition(continuousAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
