 ...
 * from:
 *   /org.eclipse.sirius.agrafe.grafcet/model/grafcet.ecore
 *   /org.eclipse.sirius.agrafe.grafcet/model/terms.ecore
 * using:
 *   /org.eclipse.sirius.agrafe.grafcet/model/grafcet.genmodel
 ...
 */
public class GrafcetTables extends AbstractTables
{
	static {
		Init.initStart();
	}
	...
	public static final /*@NonInvalid*/ NsURIPackageId PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore = IdManager.getNsURIPackageId("platform:/plugin/org.eclipse.gmf.grafcet/model/grafcet.ecore", null, GrafcetPackage.eINSTANCE);
	public static final /*@NonInvalid*/ NsURIPackageId PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore = IdManager.getNsURIPackageId("platform:/plugin/org.eclipse.gmf.grafcet/model/terms.ecore", null, TermsPackage.eINSTANCE);
	public static final /*@NonInvalid*/ ClassId CLSSid_Action = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Action", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_ActionLink = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("ActionLink", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_ActionType = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("ActionType", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Arc = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Arc", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Bool = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Bool", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Class = GrafcetTables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Condition = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Condition", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_ContinuousAction = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("ContinuousAction", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_EnclosingStep = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("EnclosingStep", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_EntryStep = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("EntryStep", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_ExitStep = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("ExitStep", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_FallingEdge = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("FallingEdge", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_ForcingOrder = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("ForcingOrder", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Grafcet = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Grafcet", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_InitializableType = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("InitializableType", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Macrostep = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Macrostep", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_MacrostepExpansion = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("MacrostepExpansion", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Node = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Node", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Operator = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Operator", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_PartialGrafcet = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("PartialGrafcet", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_RisingEdge = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("RisingEdge", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Sort = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Sort", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Step = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Step", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_StoredAction = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("StoredAction", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Synchronization = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Synchronization", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Term = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Term", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Transition = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("Transition", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Variable = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Variable", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_VariableDeclaration = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("VariableDeclaration", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_VariableDeclarationContainer = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("VariableDeclarationContainer", 0);
	...
	public static final /*@NonInvalid*/ EnumerationId ENUMid_ContinuousActionType = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getEnumerationId("ContinuousActionType");
	public static final /*@NonInvalid*/ EnumerationId ENUMid_ForcingOrderType = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getEnumerationId("ForcingOrderType");
	public static final /*@NonInvalid*/ EnumerationId ENUMid_StoredActionType = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getEnumerationId("StoredActionType");
	public static final /*@NonInvalid*/ EnumerationId ENUMid_TimeConditionType = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getEnumerationId("TimeConditionType");
	public static final /*@NonInvalid*/ EnumerationId ENUMid_TimeUnit = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getEnumerationId("TimeUnit");
	public static final /*@NonInvalid*/ EnumerationId ENUMid_VariableDeclarationType = GrafcetTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getEnumerationId("VariableDeclarationType");
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Grafcet__macrosteps = new EcoreExecutorProperty(GrafcetPackage.Literals.GRAFCET__MACROSTEPS, Types._Grafcet, 3);
		public static final ExecutorProperty _Grafcet__name = new EcoreExecutorProperty(GrafcetPackage.Literals.GRAFCET__NAME, Types._Grafcet, 4);
		public static final ExecutorProperty _Grafcet__partialGrafcets = new EcoreExecutorProperty(GrafcetPackage.Literals.GRAFCET__PARTIAL_GRAFCETS, Types._Grafcet, 5);
		public static final ExecutorProperty _Grafcet__steps = new EcoreExecutorProperty(GrafcetPackage.Literals.GRAFCET__STEPS, Types._Grafcet, 6);
		public static final ExecutorProperty _Grafcet__synchronizations = new EcoreExecutorProperty(GrafcetPackage.Literals.GRAFCET__SYNCHRONIZATIONS, Types._Grafcet, 7);
		public static final ExecutorProperty _Grafcet__transitions = new EcoreExecutorProperty(GrafcetPackage.Literals.GRAFCET__TRANSITIONS, Types._Grafcet, 8);
		public static final ExecutorProperty _Grafcet__variableDeclarationContainer = new EcoreExecutorProperty(GrafcetPackage.Literals.GRAFCET__VARIABLE_DECLARATION_CONTAINER, Types._Grafcet, 9);
		public static final ExecutorProperty _Grafcet__Grafcet__partialGrafcets = new ExecutorPropertyWithImplementation("Grafcet", Types._Grafcet, 10, new EcoreLibraryOppositeProperty(GrafcetPackage.Literals.GRAFCET__PARTIAL_GRAFCETS));
		...
		public static final ExecutorProperty _InitializableType__VariableDeclaration__step = new ExecutorPropertyWithImplementation("VariableDeclaration", Types._InitializableType, 4, new EcoreLibraryOppositeProperty(TermsPackage.Literals.VARIABLE_DECLARATION__STEP));
	...
	private GrafcetTables() {
		super(GrafcetPackage.eNS_URI);
	}
}
