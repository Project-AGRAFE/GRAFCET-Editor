 ...
 * <!-- end-user-doc -->
 * @see grafcet.GrafcetPackage#getTimeConditionType()
 * @model
 * @generated
 */
public enum TimeConditionType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TimeConditionType[] VALUES_ARRAY =
		new TimeConditionType[] {
			NONE,
			TIME_DEPENDENT,
			TIME_DELAYED,
			TIME_LIMITED,
	...
	public static TimeConditionType get(int value) {
		switch (value) {
			...
			case TIME_DEPENDENT_VALUE: return TIME_DEPENDENT;
