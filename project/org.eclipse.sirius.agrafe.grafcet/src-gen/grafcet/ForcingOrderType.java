 ...
 * <!-- end-user-doc -->
 * @see grafcet.GrafcetPackage#getForcingOrderType()
 * @model
 * @generated
 */
public enum ForcingOrderType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final ForcingOrderType[] VALUES_ARRAY =
		new ForcingOrderType[] {
			CURRENT_SITUATION,
			EMPTY_SITUATION,
			INITIAL_SITUATION,
			EXPLICIT_SITUATION,
	...
	public static ForcingOrderType get(int value) {
		switch (value) {
			case CURRENT_SITUATION_VALUE: return CURRENT_SITUATION;
			case EMPTY_SITUATION_VALUE: return EMPTY_SITUATION;
			case INITIAL_SITUATION_VALUE: return INITIAL_SITUATION;
			case EXPLICIT_SITUATION_VALUE: return EXPLICIT_SITUATION;
		}
		return null;
	}
