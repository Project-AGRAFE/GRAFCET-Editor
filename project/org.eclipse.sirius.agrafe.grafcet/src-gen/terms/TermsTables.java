 ...
 */
public class TermsTables extends AbstractTables
{
	static {
		Init.initStart();
	}
	...
	public static final /*@NonInvalid*/ ClassId CLSSid_Addition = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Addition", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_And = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("And", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Bool = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Bool", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_BooleanConstant = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("BooleanConstant", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_BooleanOperator = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("BooleanOperator", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Class = TermsTables.PACKid_$metamodel$.getClassId("Class", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Equality = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Equality", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_FallingEdge = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("FallingEdge", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_GreaterThan = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("GreaterThan", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_InitializableType = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_grafcet_ecore.getClassId("InitializableType", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Integer = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Integer", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_IntegerConstant = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("IntegerConstant", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_IntegerOperator = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("IntegerOperator", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_LessThan = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("LessThan", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Not = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Not", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Operator = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Operator", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Or = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Or", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_RisingEdge = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("RisingEdge", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Sort = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Sort", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Substraction = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Substraction", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Term = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Term", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_Variable = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("Variable", 0);
	public static final /*@NonInvalid*/ ClassId CLSSid_VariableDeclaration = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getClassId("VariableDeclaration", 0);
	...
	public static final /*@NonInvalid*/ EnumerationId ENUMid_VariableDeclarationType = TermsTables.PACKid_platform_c_s_plugin_s_org_eclipse_gmf_grafcet_s_model_s_terms_ecore.getEnumerationId("VariableDeclarationType");
	...
	public static class Properties {
		...
		public static final ExecutorProperty _Term__Condition__term = new ExecutorPropertyWithImplementation("Condition", Types._Term, 2, new EcoreLibraryOppositeProperty(GrafcetPackage.Literals.CONDITION__TERM));
		public static final ExecutorProperty _Term__Operator__subterm = new ExecutorPropertyWithImplementation("Operator", Types._Term, 3, new EcoreLibraryOppositeProperty(TermsPackage.Literals.OPERATOR__SUBTERM));
		public static final ExecutorProperty _Term__StoredAction__value = new ExecutorPropertyWithImplementation("StoredAction", Types._Term, 4, new EcoreLibraryOppositeProperty(GrafcetPackage.Literals.STORED_ACTION__VALUE));
		...
		public static final ExecutorProperty _Variable__Action__variable = new ExecutorPropertyWithImplementation("Action", Types._Variable, 1, new EcoreLibraryOppositeProperty(GrafcetPackage.Literals.ACTION__VARIABLE));
		...
		public static final ExecutorProperty _VariableDeclaration__VariableDeclarationContainer__variableDeclarations = new ExecutorPropertyWithImplementation("VariableDeclarationContainer", Types._VariableDeclaration, 5, new EcoreLibraryOppositeProperty(GrafcetPackage.Literals.VARIABLE_DECLARATION_CONTAINER__VARIABLE_DECLARATIONS));
		static {
			Init.initEnd();
		}
