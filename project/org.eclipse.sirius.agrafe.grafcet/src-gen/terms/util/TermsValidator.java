...
public class TermsValidator extends EObjectValidator {
	...
	public boolean validateVariable(Variable variable, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateVariable_SortVariable(variable, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateVariable_SortVariable(Variable variable, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateVariableDeclaration(VariableDeclaration variableDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateVariableDeclaration_StepVarDeclSetStep(variableDeclaration, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateVariableDeclaration_StepVarDeclSetStep(VariableDeclaration variableDeclaration, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateOperator(Operator operator, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(operator, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(operator, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateOperator_OperatorSort(Operator operator, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateOperator_OperatorInputType(Operator operator, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateConstant(Constant constant, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(constant, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(constant, diagnostics, context);
		return result;
	}
	...
	public boolean validateBooleanOperator(BooleanOperator booleanOperator, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(booleanOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(booleanOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validateBooleanOperator_InputOutputTypesBoolOp(booleanOperator, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateBooleanOperator_InputOutputTypesBoolOp(BooleanOperator booleanOperator, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateAnd(And and, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(and, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(and, diagnostics, context);
		if (result || diagnostics != null) result &= validateBooleanOperator_InputOutputTypesBoolOp(and, diagnostics, context);
		if (result || diagnostics != null) result &= validateAnd_InputSizeAnd(and, diagnostics, context);
		return result;
	}
	...
	public boolean validateOr(Or or, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(or, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(or, diagnostics, context);
		if (result || diagnostics != null) result &= validateBooleanOperator_InputOutputTypesBoolOp(or, diagnostics, context);
		if (result || diagnostics != null) result &= validateOr_InputSizeOr(or, diagnostics, context);
		return result;
	}
	...
	public boolean validateNot(Not not, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(not, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(not, diagnostics, context);
		if (result || diagnostics != null) result &= validateBooleanOperator_InputOutputTypesBoolOp(not, diagnostics, context);
		if (result || diagnostics != null) result &= validateNot_InputSizeNot(not, diagnostics, context);
		return result;
	}
	...
	public boolean validateEquality(Equality equality, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(equality, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(equality, diagnostics, context);
		if (result || diagnostics != null) result &= validateEquality_InputSizeInputOutputTypesEq(equality, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateEquality_InputSizeInputOutputTypesEq(Equality equality, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateBooleanConstant(BooleanConstant booleanConstant, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(booleanConstant, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(booleanConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validateBooleanConstant_InputSizeOutputTypesBoolConst(booleanConstant, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateBooleanConstant_InputSizeOutputTypesBoolConst(BooleanConstant booleanConstant, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateIntegerOperator(IntegerOperator integerOperator, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(integerOperator, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(integerOperator, diagnostics, context);
		if (result || diagnostics != null) result &= validateIntegerOperator_InputSizeTypesIntOp(integerOperator, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateIntegerOperator_InputSizeTypesIntOp(IntegerOperator integerOperator, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateAddition(Addition addition, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(addition, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validateIntegerOperator_InputSizeTypesIntOp(addition, diagnostics, context);
		if (result || diagnostics != null) result &= validateAddition_OutputTypesAdd(addition, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateAddition_OutputTypesAdd(Addition addition, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateSubstraction(Substraction substraction, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(substraction, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validateIntegerOperator_InputSizeTypesIntOp(substraction, diagnostics, context);
		if (result || diagnostics != null) result &= validateSubstraction_OutputTypesSubstr(substraction, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateSubstraction_OutputTypesSubstr(Substraction substraction, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateGreaterThan(GreaterThan greaterThan, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(greaterThan, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(greaterThan, diagnostics, context);
		if (result || diagnostics != null) result &= validateIntegerOperator_InputSizeTypesIntOp(greaterThan, diagnostics, context);
		if (result || diagnostics != null) result &= validateGreaterThan_OutputTypesGreat(greaterThan, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateGreaterThan_OutputTypesGreat(GreaterThan greaterThan, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateLessThan(LessThan lessThan, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(lessThan, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(lessThan, diagnostics, context);
		if (result || diagnostics != null) result &= validateIntegerOperator_InputSizeTypesIntOp(lessThan, diagnostics, context);
		if (result || diagnostics != null) result &= validateLessThan_OutputTypesLess(lessThan, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateLessThan_OutputTypesLess(LessThan lessThan, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateIntegerConstant(IntegerConstant integerConstant, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(integerConstant, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(integerConstant, diagnostics, context);
		if (result || diagnostics != null) result &= validateIntegerConstant_InputSizeOutputTypesIntConts(integerConstant, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateIntegerConstant_InputSizeOutputTypesIntConts(IntegerConstant integerConstant, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateRisingEdge(RisingEdge risingEdge, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(risingEdge, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validateBooleanOperator_InputOutputTypesBoolOp(risingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validateRisingEdge_InputSizeRisingEdge(risingEdge, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateRisingEdge_InputSizeRisingEdge(RisingEdge risingEdge, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateFallingEdge(FallingEdge fallingEdge, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(fallingEdge, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorInputType(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validateOperator_OperatorSort(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validateBooleanOperator_InputOutputTypesBoolOp(fallingEdge, diagnostics, context);
		if (result || diagnostics != null) result &= validateFallingEdge_InputSizeFallingEdge(fallingEdge, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateFallingEdge_InputSizeFallingEdge(FallingEdge fallingEdge, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateVariableDeclarationType(VariableDeclarationType variableDeclarationType, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return true;
	}
