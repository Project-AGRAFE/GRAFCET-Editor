	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case TermsPackage.SUBSTRACTION: {
				...
				if (result == null) result = caseIntegerOperator(substraction);
				if (result == null) result = caseOperator(substraction);
				if (result == null) result = caseTerm(substraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case TermsPackage.INTEGER_CONSTANT: {
				...
				if (result == null) result = caseOperator(integerConstant);
				if (result == null) result = caseTerm(integerConstant);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TermsPackage.RISING_EDGE: {
				...
				if (result == null) result = caseBooleanOperator(risingEdge);
				if (result == null) result = caseOperator(risingEdge);
				if (result == null) result = caseTerm(risingEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TermsPackage.FALLING_EDGE: {
				...
				if (result == null) result = caseBooleanOperator(fallingEdge);
				if (result == null) result = caseOperator(fallingEdge);
				if (result == null) result = caseTerm(fallingEdge);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
