...
public interface TermsPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "platform:/plugin/org.eclipse.gmf.grafcet/model/terms.ecore";
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EOperation VARIABLE___SORT_VARIABLE__DIAGNOSTICCHAIN_MAP = eINSTANCE.getVariable__SortVariable__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EAttribute VARIABLE_DECLARATION__VARIABLE_DECLARATION_TYPE = eINSTANCE.getVariableDeclaration_VariableDeclarationType();
		 ...
		 * @generated
		 */
		EOperation VARIABLE_DECLARATION___STEP_VAR_DECL_SET_STEP__DIAGNOSTICCHAIN_MAP = eINSTANCE.getVariableDeclaration__StepVarDeclSetStep__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation OPERATOR___OPERATOR_SORT__DIAGNOSTICCHAIN_MAP = eINSTANCE.getOperator__OperatorSort__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation OPERATOR___OPERATOR_INPUT_TYPE__DIAGNOSTICCHAIN_MAP = eINSTANCE.getOperator__OperatorInputType__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation BOOLEAN_OPERATOR___INPUT_OUTPUT_TYPES_BOOL_OP__DIAGNOSTICCHAIN_MAP = eINSTANCE.getBooleanOperator__InputOutputTypesBoolOp__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation EQUALITY___INPUT_SIZE_INPUT_OUTPUT_TYPES_EQ__DIAGNOSTICCHAIN_MAP = eINSTANCE.getEquality__InputSizeInputOutputTypesEq__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation BOOLEAN_CONSTANT___INPUT_SIZE_OUTPUT_TYPES_BOOL_CONST__DIAGNOSTICCHAIN_MAP = eINSTANCE.getBooleanConstant__InputSizeOutputTypesBoolConst__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation INTEGER_OPERATOR___INPUT_SIZE_TYPES_INT_OP__DIAGNOSTICCHAIN_MAP = eINSTANCE.getIntegerOperator__InputSizeTypesIntOp__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation ADDITION___OUTPUT_TYPES_ADD__DIAGNOSTICCHAIN_MAP = eINSTANCE.getAddition__OutputTypesAdd__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation SUBSTRACTION___OUTPUT_TYPES_SUBSTR__DIAGNOSTICCHAIN_MAP = eINSTANCE.getSubstraction__OutputTypesSubstr__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation GREATER_THAN___OUTPUT_TYPES_GREAT__DIAGNOSTICCHAIN_MAP = eINSTANCE.getGreaterThan__OutputTypesGreat__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation LESS_THAN___OUTPUT_TYPES_LESS__DIAGNOSTICCHAIN_MAP = eINSTANCE.getLessThan__OutputTypesLess__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation INTEGER_CONSTANT___INPUT_SIZE_OUTPUT_TYPES_INT_CONTS__DIAGNOSTICCHAIN_MAP = eINSTANCE.getIntegerConstant__InputSizeOutputTypesIntConts__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation RISING_EDGE___INPUT_SIZE_RISING_EDGE__DIAGNOSTICCHAIN_MAP = eINSTANCE.getRisingEdge__InputSizeRisingEdge__DiagnosticChain_Map();
		 ...
		 * @generated
		 */
		EOperation FALLING_EDGE___INPUT_SIZE_FALLING_EDGE__DIAGNOSTICCHAIN_MAP = eINSTANCE.getFallingEdge__InputSizeFallingEdge__DiagnosticChain_Map();
