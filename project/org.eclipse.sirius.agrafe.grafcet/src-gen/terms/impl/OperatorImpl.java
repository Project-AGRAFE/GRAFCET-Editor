...
public abstract class OperatorImpl extends TermImpl implements Operator {
	...
	public NotificationChain basicSetOutput(Sort newOutput, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TermsPackage.OPERATOR__OUTPUT, oldOutput, newOutput);
	...
	public void setOutput(Sort newOutput) {
		if (newOutput != output) {
			...
			if (output != null)
				msgs = ((InternalEObject)output).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TermsPackage.OPERATOR__OUTPUT, null, msgs);
			if (newOutput != null)
				msgs = ((InternalEObject)newOutput).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TermsPackage.OPERATOR__OUTPUT, null, msgs);
	...
	public boolean OperatorSort(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.OPERATOR___OPERATOR_SORT__DIAGNOSTICCHAIN_MAP);
	...
	public boolean OperatorInputType(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.OPERATOR___OPERATOR_INPUT_TYPE__DIAGNOSTICCHAIN_MAP);
			final /*@NonInvalid*/ boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, TermsTables.INT_0).booleanValue();
			/*@NonInvalid*/ boolean local_0;
			if (le) {
				local_0 = true;
				...
				final /*@NonInvalid*/ OrderedSetValue BOXED_subterm = idResolver.createOrderedSetOfAll(TermsTables.ORD_CLSSid_Term, subterm);
				/*@Thrown*/ Accumulator accumulator = ValueUtil.createSequenceAccumulatorValue(TermsTables.SEQ_CLSSid_Sort);
				...
				final /*@NonInvalid*/ SequenceValue asSequence = CollectionAsSequenceOperation.INSTANCE.evaluate(BOXED_input);
