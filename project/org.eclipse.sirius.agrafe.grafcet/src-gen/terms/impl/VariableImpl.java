...
public class VariableImpl extends TermImpl implements Variable {
		...
		if (variableDeclaration != null && variableDeclaration.eIsProxy()) {
			...
			if (variableDeclaration != oldVariableDeclaration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TermsPackage.VARIABLE__VARIABLE_DECLARATION, oldVariableDeclaration, variableDeclaration));
			}
		}
	...
	public void setVariableDeclaration(VariableDeclaration newVariableDeclaration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermsPackage.VARIABLE__VARIABLE_DECLARATION, oldVariableDeclaration, variableDeclaration));
	}
	...
	public boolean SortVariable(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.VARIABLE___SORT_VARIABLE__DIAGNOSTICCHAIN_MAP);
