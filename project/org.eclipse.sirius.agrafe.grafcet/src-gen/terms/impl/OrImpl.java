...
public class OrImpl extends BooleanOperatorImpl implements Or {
	...
	public boolean InputSizeOr(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.OR___INPUT_SIZE_OR__DIAGNOSTICCHAIN_MAP);
