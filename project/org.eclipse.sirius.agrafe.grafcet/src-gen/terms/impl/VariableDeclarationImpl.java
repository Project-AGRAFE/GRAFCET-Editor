...
public class VariableDeclarationImpl extends MinimalEObjectImpl.Container implements VariableDeclaration {
	...
	public NotificationChain basicSetSort(Sort newSort, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TermsPackage.VARIABLE_DECLARATION__SORT, oldSort, newSort);
	...
	public void setSort(Sort newSort) {
		if (newSort != sort) {
			...
			if (sort != null)
				msgs = ((InternalEObject)sort).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TermsPackage.VARIABLE_DECLARATION__SORT, null, msgs);
			if (newSort != null)
				msgs = ((InternalEObject)newSort).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TermsPackage.VARIABLE_DECLARATION__SORT, null, msgs);
			msgs = basicSetSort(newSort, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermsPackage.VARIABLE_DECLARATION__SORT, newSort, newSort));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermsPackage.VARIABLE_DECLARATION__NAME, oldName, name));
	}
	...
	public void setVariableDeclarationType(VariableDeclarationType newVariableDeclarationType) {
		...
		variableDeclarationType = newVariableDeclarationType == null ? VARIABLE_DECLARATION_TYPE_EDEFAULT : newVariableDeclarationType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermsPackage.VARIABLE_DECLARATION__VARIABLE_DECLARATION_TYPE, oldVariableDeclarationType, variableDeclarationType));
	}
	...
	public InitializableType getStep() {
		if (step != null && step.eIsProxy()) {
			...
			if (step != oldStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TermsPackage.VARIABLE_DECLARATION__STEP, oldStep, step));
			}
		}
		return step;
	}
	...
	public void setStep(InitializableType newStep) {
		...
		step = newStep;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermsPackage.VARIABLE_DECLARATION__STEP, oldStep, step));
	}
	...
	public boolean StepVarDeclSetStep(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.VARIABLE_DECLARATION___STEP_VAR_DECL_SET_STEP__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_Bool = idResolver.getClass(TermsTables.CLSSid_Bool, null);
					final /*@NonInvalid*/ VariableDeclarationType variableDeclarationType = this.getVariableDeclarationType();
					final /*@NonInvalid*/ EnumerationLiteralId BOXED_variableDeclarationType = variableDeclarationType == null ? null : TermsTables.ENUMid_VariableDeclarationType.getEnumerationLiteralId(ClassUtil.nonNullState(variableDeclarationType.getName()));
					...
					if (!eq) {
						...
						if (!ne) {
							...
							final /*@NonInvalid*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, sort, TYP_terms_c_c_Bool).booleanValue();
							if (!oclIsKindOf) {
								and = ValueUtil.FALSE_VALUE;
							}
							else {
				...
				final /*@NonInvalid*/ boolean logDiagnostic = CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity_0, CAUGHT_result, TermsTables.INT_0).booleanValue();
