...
public class NotImpl extends BooleanOperatorImpl implements Not {
	...
	public boolean InputSizeNot(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.NOT___INPUT_SIZE_NOT__DIAGNOSTICCHAIN_MAP);
