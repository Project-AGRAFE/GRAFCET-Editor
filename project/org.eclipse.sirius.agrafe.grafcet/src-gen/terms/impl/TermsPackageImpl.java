...
import grafcet.impl.GrafcetPackageImpl;
...
public class TermsPackageImpl extends EPackageImpl implements TermsPackage {
	...
	public static TermsPackage init() {
		...
		GrafcetPackageImpl theGrafcetPackage = (GrafcetPackageImpl)(registeredPackage instanceof GrafcetPackageImpl ? registeredPackage : GrafcetPackage.eINSTANCE);
	...
	public void createPackageContents() {
		...
		createEOperation(booleanConstantEClass, BOOLEAN_CONSTANT___INPUT_SIZE_OUTPUT_TYPES_BOOL_CONST__DIAGNOSTICCHAIN_MAP);
		...
		createEOperation(integerConstantEClass, INTEGER_CONSTANT___INPUT_SIZE_OUTPUT_TYPES_INT_CONTS__DIAGNOSTICCHAIN_MAP);
	...
	public void initializePackageContents() {
		...
		GrafcetPackage theGrafcetPackage = (GrafcetPackage)EPackage.Registry.INSTANCE.getEPackage(GrafcetPackage.eNS_URI);
		...
		initEReference(getTerm_Sort(), this.getSort(), null, "sort", null, 1, 1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTerm_Id(), ecorePackage.getEInt(), "id", null, 1, 1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(variableEClass, Variable.class, "Variable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVariable_VariableDeclaration(), this.getVariableDeclaration(), null, "variableDeclaration", null, 1, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(getVariable__SortVariable__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "SortVariable", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getVariableDeclaration_Sort(), this.getSort(), null, "sort", null, 1, 1, VariableDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVariableDeclaration_Name(), ecorePackage.getEString(), "name", null, 0, 1, VariableDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVariableDeclaration_VariableDeclarationType(), this.getVariableDeclarationType(), "variableDeclarationType", null, 0, 1, VariableDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVariableDeclaration_Step(), theGrafcetPackage.getInitializableType(), null, "step", null, 0, 1, VariableDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getVariableDeclaration__StepVarDeclSetStep__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "StepVarDeclSetStep", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getOperator_Output(), this.getSort(), null, "output", null, 1, 1, Operator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOperator_Input(), this.getSort(), null, "input", null, 0, -1, Operator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		op = initEOperation(getOperator__OperatorSort__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "OperatorSort", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getOperator__OperatorInputType__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "OperatorInputType", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEAttribute(getSort_Id(), ecorePackage.getEInt(), "id", null, 1, 1, Sort.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(boolEClass, Bool.class, "Bool", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(integerEClass, terms.Integer.class, "Integer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		op = initEOperation(getBooleanOperator__InputOutputTypesBoolOp__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputOutputTypesBoolOp", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getAnd__InputSizeAnd__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeAnd", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getOr__InputSizeOr__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeOr", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getNot__InputSizeNot__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeNot", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getEquality__InputSizeInputOutputTypesEq__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeInputOutputTypesEq", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getBooleanConstant__InputSizeOutputTypesBoolConst__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeOutputTypesBoolConst", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getIntegerOperator__InputSizeTypesIntOp__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeTypesIntOp", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getAddition__OutputTypesAdd__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "OutputTypesAdd", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getSubstraction__OutputTypesSubstr__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "OutputTypesSubstr", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getGreaterThan__OutputTypesGreat__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "OutputTypesGreat", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getLessThan__OutputTypesLess__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "OutputTypesLess", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		op = initEOperation(getIntegerConstant__InputSizeOutputTypesIntConts__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeOutputTypesIntConts", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEClass(risingEdgeEClass, RisingEdge.class, "RisingEdge", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = initEOperation(getRisingEdge__InputSizeRisingEdge__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeRisingEdge", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
		...
		initEClass(fallingEdgeEClass, FallingEdge.class, "FallingEdge", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = initEOperation(getFallingEdge__InputSizeFallingEdge__DiagnosticChain_Map(), ecorePackage.getEBoolean(), "InputSizeFallingEdge", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diagnostics", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		g2 = createEGenericType(ecorePackage.getEJavaObject());
		g1.getETypeArguments().add(g2);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (variableEClass,
		   source,
		   new String[] {
			   "constraints", "SortVariable"
		   });
		addAnnotation
		  (variableDeclarationEClass,
		   source,
		   new String[] {
			   "constraints", "StepVarDeclSetStep"
		   });
		addAnnotation
		  (operatorEClass,
		   source,
		   new String[] {
			   "constraints", "OperatorInputType"
		   });
		addAnnotation
		  (booleanOperatorEClass,
		   source,
		   new String[] {
			   "constraints", "InputOutputTypesBoolOp"
		   });
		addAnnotation
		  (andEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeAnd"
		   });
		addAnnotation
		  (orEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeOr"
		   });
		addAnnotation
		  (notEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeNot"
		   });
		addAnnotation
		  (equalityEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeInputOutputTypesEq"
		   });
		addAnnotation
		  (booleanConstantEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeOutputTypesBoolConst"
		   });
		addAnnotation
		  (integerOperatorEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeTypesIntOp"
		   });
		addAnnotation
		  (additionEClass,
		   source,
		   new String[] {
			   "constraints", "OutputTypesAdd"
		   });
		addAnnotation
		  (substractionEClass,
		   source,
		   new String[] {
			   "constraints", "OutputTypesSubstr"
		   });
		addAnnotation
		  (greaterThanEClass,
		   source,
		   new String[] {
			   "constraints", "OutputTypesGreat"
		   });
		addAnnotation
		  (lessThanEClass,
		   source,
		   new String[] {
			   "constraints", "OutputTypesLess"
		   });
		addAnnotation
		  (integerConstantEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeOutputTypesIntConts"
		   });
		addAnnotation
		  (risingEdgeEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeRisingEdge"
		   });
		addAnnotation
		  (fallingEdgeEClass,
		   source,
		   new String[] {
			   "constraints", "InputSizeFallingEdge"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getVariable__SortVariable__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.sort = self.variableDeclaration.sort"
		   });
		addAnnotation
		  (getVariableDeclaration__StepVarDeclSetStep__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.variableDeclarationType = VariableDeclarationType::step implies step <> null and self.sort.oclIsKindOf(Bool)"
		   });
		addAnnotation
		  (getOperator__OperatorSort__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.sort = self.output"
		   });
		addAnnotation
		  (getOperator__OperatorInputType__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.subterm->collect(subterm|subterm.sort) = self.input->asSequence()"
		   });
		addAnnotation
		  (getBooleanOperator__InputOutputTypesBoolOp__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.output.oclIsKindOf(Bool) and  self.input->forAll(c | c.oclIsKindOf(Bool))"
		   });
		addAnnotation
		  (getAnd__InputSizeAnd__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.input-> size() = 2"
		   });
		addAnnotation
		  (getOr__InputSizeOr__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.input-> size() = 2"
		   });
		addAnnotation
		  (getNot__InputSizeNot__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.input-> size() = 1"
		   });
		addAnnotation
		  (getEquality__InputSizeInputOutputTypesEq__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.input-> size() >= 2 and self.output.oclIsKindOf(Bool) and self.input->forAll(c,d|c.oclIsTypeOf(d.oclType()) or d.oclIsTypeOf(c.oclType()))"
		   });
		addAnnotation
		  (getBooleanConstant__InputSizeOutputTypesBoolConst__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.input-> size() = 0 and self.output.oclIsTypeOf(Bool)"
		   });
		addAnnotation
		  (getIntegerOperator__InputSizeTypesIntOp__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.input-> size() = 2 and self.input->forAll(c | c.oclIsKindOf(_\'Integer\'))"
		   });
		addAnnotation
		  (getAddition__OutputTypesAdd__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.output.oclIsKindOf(_\'Integer\')"
		   });
		addAnnotation
		...
		addAnnotation
		  (getGreaterThan__OutputTypesGreat__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.output.oclIsKindOf(Bool)"
		   });
		addAnnotation
		...
		addAnnotation
		  (getIntegerConstant__InputSizeOutputTypesIntConts__DiagnosticChain_Map(),
		   source,
		   new String[] {
			   "body", "self.input->size() = 0 and self.output.oclIsTypeOf(_\'Integer\')"
		   });
		addAnnotation
