...
public class AdditionImpl extends IntegerOperatorImpl implements Addition {
	...
	public boolean OutputTypesAdd(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.ADDITION___OUTPUT_TYPES_ADD__DIAGNOSTICCHAIN_MAP);
