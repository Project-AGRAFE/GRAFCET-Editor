...
public class AndImpl extends BooleanOperatorImpl implements And {
	...
	protected EClass eStaticClass() {
		return TermsPackage.Literals.AND;
	}
	 ...
	 * @generated
	 */
	public boolean InputSizeAnd(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "And::InputSizeAnd";
		try {
			/**
			 *
			 * inv InputSizeAnd:
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.AND___INPUT_SIZE_AND__DIAGNOSTICCHAIN_MAP);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TermsPackage.AND___INPUT_SIZE_AND__DIAGNOSTICCHAIN_MAP:
				return InputSizeAnd((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
