...
public class TermsFactoryImpl extends EFactoryImpl implements TermsFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case TermsPackage.VARIABLE_DECLARATION: return createVariableDeclaration();
			case TermsPackage.BOOL: return createBool();
			case TermsPackage.INTEGER: return createInteger();
			case TermsPackage.AND: return createAnd();
			case TermsPackage.OR: return createOr();
			case TermsPackage.NOT: return createNot();
			case TermsPackage.EQUALITY: return createEquality();
			case TermsPackage.BOOLEAN_CONSTANT: return createBooleanConstant();
			case TermsPackage.ADDITION: return createAddition();
			case TermsPackage.SUBSTRACTION: return createSubstraction();
			case TermsPackage.GREATER_THAN: return createGreaterThan();
			case TermsPackage.LESS_THAN: return createLessThan();
			case TermsPackage.INTEGER_CONSTANT: return createIntegerConstant();
			case TermsPackage.RISING_EDGE: return createRisingEdge();
			case TermsPackage.FALLING_EDGE: return createFallingEdge();
			default:
