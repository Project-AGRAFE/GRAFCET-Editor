...
public abstract class BooleanOperatorImpl extends OperatorImpl implements BooleanOperator {
	...
	public boolean InputOutputTypesBoolOp(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.BOOLEAN_OPERATOR___INPUT_OUTPUT_TYPES_BOOL_OP__DIAGNOSTICCHAIN_MAP);
				...
				try {
					...
					if (!oclIsKindOf) {
						...
						while (true) {
							 ...
							 * c.oclIsKindOf(Bool)
							 */
							final /*@NonInvalid*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, c, TYP_terms_c_c_Bool_0).booleanValue();
							//
