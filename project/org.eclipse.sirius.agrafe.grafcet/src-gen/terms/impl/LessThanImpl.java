...
public class LessThanImpl extends IntegerOperatorImpl implements LessThan {
	...
	public boolean OutputTypesLess(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.LESS_THAN___OUTPUT_TYPES_LESS__DIAGNOSTICCHAIN_MAP);
