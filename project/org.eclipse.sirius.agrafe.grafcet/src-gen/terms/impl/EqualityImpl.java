...
public class EqualityImpl extends OperatorImpl implements Equality {
	...
	public boolean InputSizeInputOutputTypesEq(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.EQUALITY___INPUT_SIZE_INPUT_OUTPUT_TYPES_EQ__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_Bool_0 = idResolver.getClass(TermsTables.CLSSid_Bool, null);
					final /*@NonInvalid*/ List<Sort> input_0 = this.getInput();
					final /*@NonInvalid*/ OrderedSetValue BOXED_input_0 = idResolver.createOrderedSetOfAll(TermsTables.ORD_CLSSid_Sort, input_0);
					final /*@NonInvalid*/ IntegerValue size = CollectionSizeOperation.INSTANCE.evaluate(BOXED_input_0);
					final /*@NonInvalid*/ boolean ge = OclComparableGreaterThanEqualOperation.INSTANCE.evaluate(executor, size, TermsTables.INT_2).booleanValue();
					...
					if (!ge) {
						...
						final /*@NonInvalid*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, output, TYP_terms_c_c_Bool_0).booleanValue();
						if (!oclIsKindOf) {
							and = ValueUtil.FALSE_VALUE;
						}
						else {
					...
					if (and == ValueUtil.FALSE_VALUE) {
						...
						try {
							final org.eclipse.ocl.pivot.Class TYPE_forAll_0 = executor.getStaticTypeOfValue(null, BOXED_input_0);
							...
							final AbstractSimpleOperation BODY_forAll_0 = new AbstractSimpleOperation() {
								...
								public /*@Nullable*/ Object evaluate(final Executor executor, final TypeId typeId, final /*@Nullable*/ Object /*@NonNull*/ [] sourceAndArgumentValues) {
									...
									try {
										...
										try {
											final /*@NonInvalid*/ Sort local_0 = (Sort)c;
											final /*@NonInvalid*/ Sort local_1 = (Sort)d;
											final /*@Thrown*/ org.eclipse.ocl.pivot.Class oclType = (org.eclipse.ocl.pivot.Class)OclAnyOclTypeOperation.INSTANCE.evaluate(executor, local_1);
											if (oclType instanceof InvalidValueException) {
												throw (InvalidValueException)oclType;
											}
											final /*@Thrown*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, local_0, oclType).booleanValue();
										...
										if (CAUGHT_oclIsTypeOf == ValueUtil.TRUE_VALUE) {
											...
											try {
												final /*@NonInvalid*/ Sort local_2 = (Sort)d;
												final /*@NonInvalid*/ Sort local_3 = (Sort)c;
												final /*@Thrown*/ org.eclipse.ocl.pivot.Class oclType_0 = (org.eclipse.ocl.pivot.Class)OclAnyOclTypeOperation.INSTANCE.evaluate(executor, local_3);
												if (oclType_0 instanceof InvalidValueException) {
													throw (InvalidValueException)oclType_0;
												}
												final /*@Thrown*/ boolean oclIsTypeOf_0 = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, local_2, oclType_0).booleanValue();
							...
							final ExecutorMultipleIterationManager MGR_forAll_0 = new ExecutorMultipleIterationManager(executor, 2, TypeId.BOOLEAN, BODY_forAll_0, BOXED_input_0, ACC_forAll_0);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case TermsPackage.EQUALITY___INPUT_SIZE_INPUT_OUTPUT_TYPES_EQ__DIAGNOSTICCHAIN_MAP:
				return InputSizeInputOutputTypesEq((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
