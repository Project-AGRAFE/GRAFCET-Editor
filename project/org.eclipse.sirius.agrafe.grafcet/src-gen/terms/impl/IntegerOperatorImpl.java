...
public abstract class IntegerOperatorImpl extends OperatorImpl implements IntegerOperator {
	...
	public boolean InputSizeTypesIntOp(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		...
		try {
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, TermsPackage.Literals.INTEGER_OPERATOR___INPUT_SIZE_TYPES_INT_OP__DIAGNOSTICCHAIN_MAP);
				...
				try {
					...
					if (!eq) {
						...
						while (true) {
							 ...
							 */
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.Class TYP_terms_c_c_Integer = idResolver.getClass(TermsTables.CLSSid_Integer, null);
							final /*@NonInvalid*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, c, TYP_terms_c_c_Integer).booleanValue();
							//
