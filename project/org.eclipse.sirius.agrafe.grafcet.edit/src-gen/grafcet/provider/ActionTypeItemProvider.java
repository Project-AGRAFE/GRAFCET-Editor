...
/**
 * This is the item provider adapter for a {@link grafcet.ActionType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActionTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActionType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActionType_id_feature", "_UI_ActionType_type"),
				 GrafcetPackage.Literals.ACTION_TYPE__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_ActionType_type") + " " + actionType.getId();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ActionType.class)) {
			case GrafcetPackage.ACTION_TYPE__ID:
