...
/**
 * This is the item provider adapter for a {@link grafcet.ForcingOrder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForcingOrder_partialGrafcet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForcingOrder_partialGrafcet_feature", "_UI_ForcingOrder_type"),
				 GrafcetPackage.Literals.FORCING_ORDER__PARTIAL_GRAFCET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addForcedStepsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForcingOrder_forcedSteps_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForcingOrder_forcedSteps_feature", "_UI_ForcingOrder_type"),
				 GrafcetPackage.Literals.FORCING_ORDER__FORCED_STEPS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addForcingOrderTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ForcingOrder_forcingOrderType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ForcingOrder_forcingOrderType_feature", "_UI_ForcingOrder_type"),
				 GrafcetPackage.Literals.FORCING_ORDER__FORCING_ORDER_TYPE,
				 true,
				 false,
				 false,
