...
/**
 * This is the item provider adapter for a {@link grafcet.Grafcet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GrafcetItemProvider 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__VARIABLE_DECLARATION_CONTAINER,
				 GrafcetFactory.eINSTANCE.createVariableDeclarationContainer()));

		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__PARTIAL_GRAFCETS,
		...
		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__STEPS,
		...
		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__STEPS,
				 GrafcetFactory.eINSTANCE.createStep()));

		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__TRANSITIONS,
				 GrafcetFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__SYNCHRONIZATIONS,
				 GrafcetFactory.eINSTANCE.createSynchronization()));

		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__MACROSTEPS,
				 GrafcetFactory.eINSTANCE.createMacrostep()));

		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__ARCS,
				 GrafcetFactory.eINSTANCE.createArc()));

		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__ACTION_TYPES,
		...
		newChildDescriptors.add
			(createChildParameter
				(GrafcetPackage.Literals.GRAFCET__ACTION_LINKS,
