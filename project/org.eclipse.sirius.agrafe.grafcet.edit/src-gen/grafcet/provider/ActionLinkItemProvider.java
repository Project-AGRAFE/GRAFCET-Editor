...
/**
 * This is the item provider adapter for a {@link grafcet.ActionLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActionLink_step_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActionLink_step_feature", "_UI_ActionLink_type"),
				 GrafcetPackage.Literals.ACTION_LINK__STEP,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addActionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ActionLink_actionType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ActionLink_actionType_feature", "_UI_ActionLink_type"),
				 GrafcetPackage.Literals.ACTION_LINK__ACTION_TYPE,
				 true,
				 false,
				 true,
				 null,
