...
/**
 * This is the item provider adapter for a {@link grafcet.InitializableType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_InitializableType_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_InitializableType_initial_feature", "_UI_InitializableType_type"),
				 GrafcetPackage.Literals.INITIALIZABLE_TYPE__INITIAL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_InitializableType_activationLink_feature", "_UI_InitializableType_type"),
				 GrafcetPackage.Literals.INITIALIZABLE_TYPE__ACTIVATION_LINK,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
