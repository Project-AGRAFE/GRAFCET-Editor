...
public class OperatorItemProvider extends TermItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operator_input_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operator_input_feature", "_UI_Operator_type"),
				 TermsPackage.Literals.OPERATOR__INPUT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TermsPackage.Literals.OPERATOR__OUTPUT,
