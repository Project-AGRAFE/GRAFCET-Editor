...
/**
 * This is the item provider adapter for a {@link terms.VariableDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableDeclarationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TermsPackage.Literals.VARIABLE_DECLARATION__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Variable Declaration Type feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addVariableDeclarationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableDeclaration_variableDeclarationType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableDeclaration_variableDeclarationType_feature", "_UI_VariableDeclaration_type"),
				 TermsPackage.Literals.VARIABLE_DECLARATION__VARIABLE_DECLARATION_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VariableDeclaration_step_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VariableDeclaration_step_feature", "_UI_VariableDeclaration_type"),
				 TermsPackage.Literals.VARIABLE_DECLARATION__STEP,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TermsPackage.Literals.VARIABLE_DECLARATION__SORT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TermsPackage.Literals.VARIABLE_DECLARATION__SORT,
				 TermsFactory.eINSTANCE.createBool()));

		newChildDescriptors.add
			(createChildParameter
				(TermsPackage.Literals.VARIABLE_DECLARATION__SORT,
				 TermsFactory.eINSTANCE.createInteger()));
	}
